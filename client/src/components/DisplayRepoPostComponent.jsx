import {
  ...
  import {
    useFetchTagsMutation,   useCreateRepoDoubtMutation,
  } from "../Services/AppApi";
  import { BootstrapTooltip } from "./Navbar";
import { useParams } from "react-router-dom";
  
  const DisplayRepoPostComponent = ({ existingDoubt }) => {
    ...
    const [createDoubtFunction] = useCreateRepoDoubtMutation();
  ...
  export default DisplayRepoPostComponent;
